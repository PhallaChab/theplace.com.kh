 ...
 */
function get_next_posts_link( $label = null, $max_page = 0,$page_tap ) {
	...
	if ( !is_single() && ( $nextpage <= $max_page ) ) {
		...
		return '<a class="text_pagin" href="' . next_posts( $max_page, false ).$page_tap . "\" $attr>" . preg_replace('/&([^#])(?![a-z]{1,8};)/i', '&#038;$1', $label) . '</a>';
	}
}
 ...
 * @param int    $max_page Optional. Max pages. Default 0.
 */
function next_posts_link( $label = null, $max_page = 0,$page_tap ) {
	echo get_next_posts_link( $label, $max_page,$page_tap );
}
 ...
 */
function get_previous_posts_link( $label = null,$page_tap ) {
	global $paged;
	...
	if ( !is_single() && $paged > 1 ) {
		...
		return '<a class="text_pagin" href="' . previous_posts( false ) . "\" $attr>". preg_replace( '/&([^#])(?![a-z]{1,8};)/i', '&#038;$1', $label ) .'</a>';
	}
}
 ...
 * @param string $label Optional. Previous page link text.
 */
function previous_posts_link( $label = null ,$page_tap ) {
	echo get_previous_posts_link( $label,$page_tap);
}
